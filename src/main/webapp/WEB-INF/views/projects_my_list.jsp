...
<html lang="<%=request.getLocale() %>">
  <head>
    ...
    <title><spring:message code="common.pj.name" /> | <spring:message code="project_my_list.head.title.list" /> </title>
  </head>
          ...
          <table class="table table-hover">
            <thead>
              <caption class="cptn background-primary">
                <spring:message code="project_my_list.label.title.list" />
              </caption>
              <tr>
                <th class="th-width-70 active"><spring:message code="project_my_list.label.title" /></th>
                <th class="th-width-30 active"><spring:message code="project_my_list.label.recruitment_area" /></th>
              </tr>
              <tr>
                <th class="th-width-100 active" colspan="2" ><spring:message code="project_my_list.label.over_view" /></th>
              </tr>
            </thead>
            <tbody>
              <c:forEach var="projectModel" items="${projectModelList}">
              <tr>
                <td class="td-width-70"><a href="<%=request.getContextPath() %>/users/${projectModel.userName}/projects/${projectModel.projectId}/edit">
